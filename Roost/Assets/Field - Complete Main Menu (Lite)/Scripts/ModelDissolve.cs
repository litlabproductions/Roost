...
public class ModelDissolve : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        dissolveMaterial1.SetFloat("Vector1_7C536670", dissolveValue);
        dissolveMaterial2.SetFloat("Vector1_7C536670", dissolveValue);
        dissolveMaterial3.SetFloat("Vector1_7C536670", dissolveValue);
    }
}