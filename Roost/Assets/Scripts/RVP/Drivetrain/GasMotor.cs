...
namespace RVP
{
    ...
    public class GasMotor : Motor
    {
        ...
        public override void FixedUpdate()
        {
            ...
            accelGet = canReverse ? actualAccel : Mathf.Clamp01(actualAccel);
            ...
            if (ignition)
            {
                ...
                if (actualInput == 0f)
                    vp.GetComponent<Rigidbody>().drag = driveForceDrag;    
                else
                    vp.GetComponent<Rigidbody>().drag = 0;
            ...
            accelTest = actualAccel;
            inputTest = actualInput;
            pitchTest  = targetPitch;
        }
        ...
        public override void Update()
        {
            ...
            actualRPM = Mathf.Abs((targetDrive.feedbackRPM * 0.001f) / maxRPM);
        }
